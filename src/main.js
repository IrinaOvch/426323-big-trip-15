...
render(mainInfoContainer, createTripInfoTemplate(points), 'afterbegin');
...
render(pointsList, createEditPointFormTemplate(points[0]), 'beforeend');

points.slice(1).forEach((_, i) => render(pointsList, createTripPointTemplate(points[i+1]), 'beforeend'));
